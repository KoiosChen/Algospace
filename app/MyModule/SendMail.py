...
class sendmail:
    def __init__(self, **kwargs):
        self.HOST = kwargs.setdefault('host', "smtp.partner.outlook.cn")
        ...
        self.FROM = kwargs.setdefault('mail_from', "noreply@algospace.com")
        self.PASSWD = kwargs.setdefault('mail_passwd', "OsiXHlmPk$bb81Ld")
    ...
    def send(self, **kwargs):
        ...
        try:
            server = smtplib.SMTP(host=self.HOST, timeout=30, port=587)
            server.starttls()
